...
#### **特别说明**
   ...
   - 规则如有实质性更新（格式调整等除外），将提前 1 天在 [DocTranslate GitHub PR](https://github.com/miguelenes/doctranslate/pulls) 公告
   - 过期未使用的兑换码不予补发
...
---
**规则公示**：本规则文档存放于 DocTranslate 仓库 [CONTRIBUTOR_REWARD.md](https://github.com/miguelenes/doctranslate/blob/main/docs/CONTRIBUTOR_REWARD.md)，并在 [Contributor Reward - DocTranslate](https://miguelenes.github.io/doctranslate/CONTRIBUTOR_REWARD/) 展示。
