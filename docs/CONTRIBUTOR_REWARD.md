# DocTranslater/PDFMathTranslate/OneAIFW 贡献者奖励规则
...
#### **申请条件**
   - PR 需被成功合并至以下几个仓库：
     1. [funstory-ai/DocTranslate](https://github.com/miguelenes/doctranslate/pulls) 仓库
   ...
   - 若目标为 [funstory-ai/DocTranslate](https://github.com/miguelenes/doctranslate/pulls) 的 PR 未被合并，但被维护者认定为有价值的概念验证，同样符合条件。
...
#### **特别说明**
   ...
   - 规则如有实质性更新（格式调整等除外），将提前 1 天在 [DocTranslater GitHub PR](https://github.com/miguelenes/doctranslate/pulls) 公告
   - 过期未使用的兑换码不予补发
...
---
**规则公示**：本规则文档存放于 DocTranslater 仓库 [CONTRIBUTOR_REWARD.md](https://github.com/miguelenes/doctranslate/blob/main/docs/CONTRIBUTOR_REWARD.md)，并在 [Contributor Reward - DocTranslater](https://miguelenes.github.io/doctranslate/CONTRIBUTOR_REWARD/) 展示。
