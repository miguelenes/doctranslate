...
| [HTTP API Python client](../http-api-python-client.md) (human docs) | Generated `doc_translater_http_api_client` from OpenAPI + convenience helpers. |
| [Observability](../observability.md) (human docs) | Logs, Prometheus `/metrics`, request IDs, optional OTLP tracing. |
