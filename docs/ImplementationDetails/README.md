...
2. [LayoutParser](https://github.com/miguelenes/doctranslate/blob/main/doctranslate/format/pdf/document_il/midend/layout_parser.py): **Layout OCR**
...
7. [FontMapper](https://github.com/miguelenes/doctranslate/blob/main/doctranslate/format/pdf/document_il/utils/fontmap.py): **Font Mapping**
