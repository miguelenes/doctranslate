...
def check_metadata(pdf: Document):
    ...
    if (
        producer
        and "DocTranslate" in producer
        and "Translation_generated_by_AI,please_carefully_discern" in producer
    ):
        raise InputFileGeneratedByBabelDOCError(
            "Input file is generated by DocTranslate, Cannot translate files that have already been translated."
        )
...
def add_metadata(
    ...
    for attr in (
        ...
        translated_by = f"DocTranslate{WATERMARK_VERSION}_{time.time()}_Translation_generated_by_AI,please_carefully_discern"
...
def do_translate(
    ...
    try:
        ...
        try:
            ...
            logger.error(
                f"input file {original_pdf_path} is generated by DocTranslate, Cannot translate files that have already been translated."
            )
            raise e
        except Exception as e:
