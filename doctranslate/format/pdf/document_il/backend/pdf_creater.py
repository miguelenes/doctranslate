...
from doctranslate.assets.embedding_assets_metadata import FONT_NAMES
from doctranslate.format.pdf.document_il import PdfOriginalPath
...
from doctranslate.format.pdf.document_il.utils.matrix_helper import matrix_to_bytes
