...
import doctranslate.pdfminer.pdfinterp
from doctranslate.format.pdf.babelpdf.base14 import get_base14_bbox
from doctranslate.format.pdf.babelpdf.cidfont import get_cidfont_bbox
from doctranslate.format.pdf.babelpdf.cidfont import get_glyph_bbox
from doctranslate.format.pdf.babelpdf.encoding import WinAnsiEncoding
from doctranslate.format.pdf.babelpdf.encoding import get_type1_encoding
from doctranslate.format.pdf.babelpdf.type3 import get_type3_bbox
...
from doctranslate.format.pdf.document_il.utils import zstd_helper
...
from doctranslate.format.pdf.document_il.utils.style_helper import YELLOW
...
# from doctranslate.pdfminer.pdfpage import PDFPage as PDFMinerPDFPage
# from doctranslate.pdfminer.pdftypes import PDFObjRef as PDFMinerPDFObjRef
# from doctranslate.pdfminer.pdftypes import resolve1 as pdftypes_resolve1
...
class ILCreater:
    ...
    def create_graphic_state(
        self,
        gs: doctranslate.pdfminer.pdfinterp.PDFGraphicState | list[tuple[str, str]],
    ...
    def on_lt_curve(self, curve: doctranslate.pdfminer.layout.LTCurve):
        if not self.enable_graphic_element_process:
            return
        bbox = il_version_1.Box(
            x=curve.bbox[0],
