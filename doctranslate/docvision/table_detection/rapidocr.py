...
import cv2
import numpy as np
from doctranslate.assets.assets import get_table_detection_rapidocr_model_path
from doctranslate.docvision.base_doclayout import YoloBox
...
try:
    ...
    raise
import doctranslate.format.pdf.document_il.il_version_1
import pymupdf
...
class RapidOCRModel:
    ...
    def handle_document(
        self,
        pages: list[doctranslate.format.pdf.document_il.il_version_1.Page],
