...
T = TypeVar("T", bound="ProgressStartEvent")
...
class ProgressStartEvent:
    ...
    Attributes:
        ...
        type_ (Literal['progress_start'] | Unset):  Default: 'progress_start'.
    """
    ...
    type_: Literal["progress_start"] | Unset = "progress_start"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["progress_start"] | Unset, d.pop("type", UNSET))
        if type_ != "progress_start" and not isinstance(type_, Unset):
            raise ValueError(f"type must match const 'progress_start', got '{type_}'")

        progress_start_event = cls(
            stage=stage,
            stage_current=stage_current,
            stage_progress=stage_progress,
            stage_total=stage_total,
